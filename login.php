...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($get->num_rows > 0){
        ...
        if($is_verify){
            ...
            echo "<script> alert('Your verification code is: {$code}.'); location.replace('2fa-verification.php');</script>";
            exit;
                ...
                <div class="col-lg-7 col-md-8 col-sm-10 col-xs-12 mx-auto">
                    <div class="card rounded-0 shadow">
                        <div class="card-header rounded-0">
                            <div class="card-title"><b>User Login</b></div>
                        </div>
                        <div class="card-body rounded-0">
                            <div class="container-fluid">
                                <form action="" id="register" method="POST">
                                    ...
                                    <button type="button" onclick="window.location.href='adminlog.php'">Admin Login</button>
                                </form>
                            </div>
                        </div>
                    </div>
